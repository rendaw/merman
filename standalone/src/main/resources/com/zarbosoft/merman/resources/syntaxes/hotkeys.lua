                ...
                rules = {
                    {
                        hotkeys = {
                            ...
                            enter = { key 'enter' },
                            save = { key { key = 's', modifiers = { 'control' } } },
                            ...
                            gather_previous_line_start = { key { key = 'home', modifiers = { 'shift' } }, },
                            gather_next_line_end = { key { key = 'end', modifiers = { 'shift' } }, },
                            ...
                            scroll_previous_alot = { key 'page_up' },
                            scroll_next_alot = { key 'page_down' },
                        },
                    },
                    {
                        with = { part 'atom' },
