...
public class TestCompaction {
	...
	static {
		...
		syntax = new Helper.SyntaxBuilder("any")
				...
				.type(mid)
				.type(high)
				.group("any", new Helper.GroupBuilder().type(one).type(low).type(mid).type(high).build())
	...
	@Test
	public void testSplitOrderDeterminism() {
	...
	@Test
	public void testSplitOrderDeterminismDynamic() {
